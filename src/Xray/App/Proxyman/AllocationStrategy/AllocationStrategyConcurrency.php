...
use Xray\App\Proxyman\AllocationStrategy_AllocationStrategyConcurrency;

/**
 * Generated from protobuf message <code>xray.app.proxyman.AllocationStrategy.AllocationStrategyConcurrency</code>
 */
class AllocationStrategyConcurrency extends Message
{
    /**
...
class_alias(AllocationStrategyConcurrency::class, AllocationStrategy_AllocationStrategyConcurrency::class);
